...
<article class="msc-block msc-slider">
	...
	<div id="accordion" role="tablist" aria-multiselectable="true" class="msc-accordion">
		<div class="card">
			...
			<div class="card-header" role="tab" id="headingFour">
				<h5 class="mb-0">
					<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
						How do we protect your information? <span id='infoPro'></span>
					</a>
				</h5>
			</div>
		...
		<div class="card">
			...
			<div id="collapseFive" class="collapse" role="tabpanel" aria-labelledby="headingFive">
				<div class="card-block">
					...
					<br /><br/><strong>We use cookies to:</strong><br />
					Understand and save user's preferences for future visits.
					<br>You can choose to have your computer warn you each time a cookie is being sent, or you can choose to turn off all cookies. You do this through your browser settings. Since browser is a little different, look at your browser's Help Menu to learn the correct way to modify your cookies.<br>
					<br>
		...
		<div class="card">
			...
			<div id="collapseSix" class="collapse" role="tabpanel" aria-labelledby="headingSix">
				<div class="card-block">
					We do not sell, trade, or otherwise transfer to outside parties your Personally Identifiable Information unless we provide users with advance notice. This does not include website hosting partners and other parties who assist us in operating our website, conducting our business, or serving our users, so long as those parties agree to keep this information confidential. We may also release information when it's release is appropriate to comply with the law, enforce our site policies, or protect ours or others' rights, property or safety. <br><br> However, non-personally identifiable visitor information may be provided to other parties for marketing, advertising, or other uses.
					<span id='trLi'></span><br/><br/>
		...
		<div class="card">
			...
			<div id="collapseSeven" class="collapse" role="tabpanel" aria-labelledby="headingSeven">
				<div class="card-block">
					...
					<br><strong>According to CalOPPA, we agree to the following:</strong><br>Users can visit our site anonymously.
		...
		<div class="card">
			...
			<div id="collapseTen" class="collapse" role="tabpanel" aria-labelledby="headingTen">
				<div class="card-block">
					...
					<span id='ftcFip'></span><br/><br/>
					<div class='blueText'><strong>Fair Information Practices</strong><br />
						...
						<strong>In order to be in line with Fair Information Practices we will take the following responsive action, should a data breach occur:</strong><br/>
		...
		<div class="card">
			...
			<div id="collapseEleven" class="collapse" role="tabpanel" aria-labelledby="headingEleven">
				<div class="card-block">
					The CAN-SPAM Act is a law that sets the rules for commercial email, establishes requirements for commercial messages, gives recipients the right to have emails stopped from being sent to them, and spells out tough penalties for violations.<br><br><strong>We collect your email address in order to:</strong><br/>
					Send information, respond to inquiries, and/or other requests or questions<br/><br/>
					...
					<strong>If at any time you would like to unsubscribe from receiving future emails, you can email us at</strong><br/>
					Follow the instructions at the bottom of each email. and we will promptly remove you from <strong>ALL</strong> correspondence.					
				</div>
			</div>
		</div>
		<br/><br/>
